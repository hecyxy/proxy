...
public class DeleteRowsEventData extends AbstractRowsEventData implements EventData {
    ...
    public void read(byte[] data) {
        ...
        includeColumns = mm.readBitSet(numberOfColumns, true);
        rows = decodeRows(mm);
    }
    ...
    public void setIncludedColumns(BitSet includedColumns) {
        this.includeColumns = includedColumns;
    }
    ...
    public String toString() {
        ...
        sb.append(", includedColumns=").append(includeColumns);
        sb.append(", rows=[");
        for (Object[] row : rows) {
