...
import space.cosmos.one.common.packet.message.FieldFlag;
import space.cosmos.one.common.packet.message.FieldType;
import space.cosmos.one.common.packet.message.MysqlField;
import space.cosmos.one.common.packet.message.ResultSetFieldMessage;
